...
const char *password = "Pakistan111";
String postData ; 
String link = "http://tritec.store/uosattendence/public/admin/finger/handle"; 
int FingerID = 0;     
uint8_t id;
...
String sendlink = "http://tritec.store/uosattendence/public/admin/finger/handle"; 
  WiFiClient client;
  HTTPClient http;  
  postData = "FingerID=" + String(finger); 
  http.begin(client,sendlink); 
...
String checklink = "http://tritec.store/uosattendence/public/admin/finger/get"; 
WiFiClient client;
  HTTPClient http;    //Declare object of class HTTPClient
  //Post Data
  ...
  http.begin(client,checklink);  //initiate HTTP request, put your Website URL or Your Computer IP 
  http.addHeader("Content-Type", "application/x-www-form-urlencoded");    //Specify content-type header
